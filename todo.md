...
- [x] ルート画面とマップ画面間のデータ共有機構の設計
- [x] ルートデータをグローバルステートで管理（RouteContext、useRouteフック）
- [x] マップ画面でルートデータを取得
- [x] Polylineコンポーネントでルートを地図上に描画（Web版はSVG polyline、ネイティブ版はPolyline）
- [x] ルート線のスタイル設定（青色#6366F1、太さ4px）
